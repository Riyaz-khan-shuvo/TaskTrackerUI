namespace TaskTracker.Models.kendocommon
{
	...
	{
		#region for Grid
		public static string Query(GridOptionVM options, string query, string orderBy, string gridCondition)
		{
			string condition = "";
			if (options != null)
			{
			...
			if (orderby == "")
			{
				...
				{
					throw new Exception("Must be set Order BY column Name");
				}
			}
		...
		public static string FilterCondition(AzFilter.GridFiltersVM filter)
		{
			string whereClause = "";
